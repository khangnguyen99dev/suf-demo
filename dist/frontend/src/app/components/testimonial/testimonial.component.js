...
let TestimonialComponent = (() => {
    ...
    var TestimonialComponent = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "TestimonialComponent");
    (() => {
        ...
        TestimonialComponent = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return TestimonialComponent = _classThis;
})();
