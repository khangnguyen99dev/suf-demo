...
exports.TeamMainComponent = void 0;
const core_1 = require("@angular/core");
const environment_1 = require("../../../environments/environment");
const common_1 = require("@angular/common");
let TeamMainComponent = (() => {
    ...
    var TeamMainComponent = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "TeamMainComponent");
    (() => {
        ...
        TeamMainComponent = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return TeamMainComponent = _classThis;
})();
exports.TeamMainComponent = TeamMainComponent;
