...
exports.BlogMainComponent = void 0;
const core_1 = require("@angular/core");
const environment_1 = require("../../../environments/environment");
const common_1 = require("@angular/common");
let BlogMainComponent = (() => {
    ...
    var BlogMainComponent = _classThis = class {
        constructor() {
    ...
    __setFunctionName(_classThis, "BlogMainComponent");
    (() => {
        ...
        BlogMainComponent = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return BlogMainComponent = _classThis;
})();
exports.BlogMainComponent = BlogMainComponent;
